...
Proof.
  ...
  rewrite H0 in H.
  simpl in H. apply IHl in H as [l1 [l2 [Hl Hc]]].
...
Proof.
  intros. induction l1; simpl; unfold union.
  (* l1 = [] *)
  unfold singleton.
...
Proof.
  ...
  intros;
  specialize H with al;
  inv H;
  apply same_contents_iff_perm in H0;
  auto.
Qed.
